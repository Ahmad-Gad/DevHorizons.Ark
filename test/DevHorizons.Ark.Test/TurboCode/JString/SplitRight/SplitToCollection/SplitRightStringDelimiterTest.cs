namespace DevHorizons.Ark.Test
{
    ...
    public class SplitRightStringDelimiterTest
    {
        ...
        public void TestSplitWithEmptyStringExceptionSource()
        {
            ...
            var ex = Record.Exception(() => source.SplitRight(string.Empty));
            Assert.NotNull(ex);
        ...
        public void TestSplitExceptionEndEqualZero()
        {
            string source = "Ahmad Gad";
            string delimiter = "12";
            var ex = Record.Exception(() => source.SplitRight(delimiter, 0, 0));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void TestSplitExceptionStartEqualToEnd()
        {
            string source = "Ahmad Gad";
            string delimiter = "12";
            var ex = Record.Exception(() => source.SplitRight(delimiter, 2, 2));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void SplitWhiteSpace()
        {
            ...
            expected.Reverse();
            var actual = source.SplitRight(JString.WhiteSpace, false);
        ...
        public void SplitMatchigCaseWord()
        {
            ...
            var expected = new List<string> { "Jan", "Feb", "Mar", "April" };
            expected.Reverse();
            var actual = source.SplitRight("HELLO", true);
            Assert.True(expected.CompareTo(actual));
        }
        ...
        public void SplitMatchigIgnoreCaseWord()
        {
            ...
            var expected = new List<string> { "Jan", "Feb", "Mar", "April" };
            expected.Reverse();
            var actual = source.SplitRight("hello", false, CultureInfo.InvariantCulture);
        ...
        public void SplitStartIndexOkWord()
        {
            ...
            var actual = source.SplitRight("HELLO", 5, true, CultureInfo.InvariantCulture);
            Assert.NotNull(actual);
        ...
        public void SplitDelimiterAtBegining()
        {
            ...
            expected.Reverse();
            var actual = source.SplitRight("HELLO");
            Assert.NotNull(actual);
        ...
        public void SplitStartIndexOkIgnoreCaseWord()
        {
            var source = "Jan HELLOFebHELLO Mar HELLO April";
            var expected = new List<string> { JString.WhiteSpace, " Mar ", "Feb", "Jan " };
            var actual = source.SplitRight("hello", 5, false);
            Assert.NotNull(actual);
        ...
        {
            var source = "Jan HELLOFebHELLO Mar HELLO April";
            var actual = source.SplitRight("hello", 5);
            Assert.Null(actual);
        }
        ...
        {
            var source = "JanHELLOFebHELLOMarHELLOApril";
            var actual = source.SplitRight("hello", 5, 25);
            Assert.Null(actual);
        }
        ...
        public void SplitStartIndexEndIndexWord()
        {
            ...
            var actual = source.SplitRight("hello", 5, 25, false);
            Assert.NotNull(actual);
        ...
        {
            var source = "JanHELLOFebHELLOMarHELLOApril";
            var actual = source.SplitRight("hello", 25, false);
            Assert.Null(actual);
        }
        ...
        {
            var source = "JanHELLOFebHELLOMarHELLOApril";
            var actual = source.SplitRight("hello", 0, 5, false);
            Assert.Null(actual);
        }
        ...
        public void SplitLongDelimiter()
        {
            ...
            expected.Reverse();
            var actual = source.SplitRight("HELLOWORLD");
            Assert.NotNull(actual);
        ...
        public void SplitDelimiterOnly2()
        {
            ...
            var expected = new List<string> { string.Empty, string.Empty };
            expected.Reverse();
            var actual = source.SplitRight("helloworld", false);
            Assert.NotNull(actual);
        ...
        public void SplitDelimiterOnlyWhiteSpace()
        {
            ...
            var expected = new List<string> { string.Empty, string.Empty };
            expected.Reverse();
            var actual = source.SplitRight(JString.WhiteSpace);
            Assert.NotNull(actual);
            Assert.True(expected.CompareTo(actual));
        }
    }
