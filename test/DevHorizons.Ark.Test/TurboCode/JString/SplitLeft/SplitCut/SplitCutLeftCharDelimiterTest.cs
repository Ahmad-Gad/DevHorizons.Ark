namespace DevHorizons.Ark.Test
{
    ...
    public class SplitCutLeftCharDelimiterTest
    {
        ...
        public void TestSplitWithEmptyExceptionSource()
        {
            ...
            var ex = Record.Exception(() => source.SplitCutLeft(Character.WhiteSpace, 0));
            Assert.NotNull(ex);
        ...
        {
            string source = string.Empty;
            var ex = Record.Exception(() => source.SplitCutLeft(Character.WhiteSpace,0, 1, 2));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        {
            var source = "Jan ZFebZ Mar Z April";
            var actual = source.SplitCutLeft('z', 0, 5);
            Assert.Null(actual);
        }
        ...
        {
            var source = "JanZFebZMarZAprilZMayZJuneZJulyZAugust";
            var actual = source.SplitCutLeft('z', 0, 5, 25);
            Assert.Null(actual);
        }
        ...
        {
            var source = "JanZFebZMarZAprilZMayZJuneZJulyZAugust";
            var actual = source.SplitCutLeft('M', 0, 25, false);
            Assert.Null(actual);
        }
        ...
        {
            var source = "JanZFebZMarZAprilZMayZJuneZJulyZAugust";
            var actual = source.SplitCutLeft('M', 0, 0, 5, false);
            Assert.Null(actual);
        }
    }
}
