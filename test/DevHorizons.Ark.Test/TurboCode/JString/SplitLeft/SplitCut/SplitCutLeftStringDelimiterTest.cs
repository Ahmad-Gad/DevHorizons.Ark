namespace DevHorizons.Ark.Test
{
    ...
    public class SplitCutLeftStringDelimiterTest
    {
        ...
        public void TestSplitWithNullExceptionSource()
        {
            ...
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, 0));
            Assert.NotNull(ex);
        ...
        public void TestSplitWithNullExceptionSourceWithStartAndEndSpecified()
        {
            string source = null;
            string delimiter = string.Empty;
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, 0, 0, 4));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentNullException>(ex);
            var argumentNullException = ex as ArgumentNullException;
            Assert.NotNull(argumentNullException);
        ...
        public void TestSplitWithEmptyStringExceptionSource()
        {
            ...
            var ex = Record.Exception(() => source.SplitCutLeft(string.Empty, 0));
            Assert.NotNull(ex);
        ...
        public void TestSplitExceptionStartLessThanZero()
        {
            ...
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, 0, -1));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void TestSplitExceptionEndEqualZero()
        {
            string source = "Ahmad Gad";
            string delimiter = "12";
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, 0, 0, 0));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void TestSplitExceptionEndLessThanZero()
        {
            string source = "Ahmad Gad";
            string delimiter = "12";
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, 0, 0, -1));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void TestSplitExceptionIndexLessThanZero()
        {
            string source = "Ahmad Gad";
            string delimiter = "12";
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, -1));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void TestSplitExceptionStartGreaterThanLengthOfSource()
        {
            string source = "Ahmad Gad";
            string delimiter = JString.WhiteSpace;
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, 0, source.Length));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void TestSplitExceptionEndGreaterThanLengthOfSource()
        {
            string source = "Ahmad Gad";
            string delimiter = "12";
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, 0, 0, source.Length));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void TestSplitExceptionStartEqualToEnd()
        {
            string source = "Ahmad Gad";
            string delimiter = "12";
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, 0, 2, 2));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void TestSplitExceptionStartGreaterThanEnd()
        {
            string source = "Ahmad Gad";
            string delimiter = "12";
            var ex = Record.Exception(() => source.SplitCutLeft(delimiter, 0, 3, 2));
            Assert.NotNull(ex);
            Assert.IsType<ArgumentException>(ex);
            var argumentException = ex as ArgumentException;
            Assert.NotNull(argumentException);
        ...
        public void SplitWhiteSpace0()
        {
            ...
            var index = 0;
            var expected = "Jan";
            var actual = source.SplitCutLeft(delimiter, index, false);
        ...
        public void SplitMatchigCaseWord0()
        {
            ...
            var index = 0;
            var expected = "Jan";
            var actual = source.SplitCutLeft(delimiter, index, true);
            Assert.Equal(expected, actual);
        }
        ...
        public void SplitMatchigIgnoreCaseWord0()
        {
            ...
            var index = 0;
            var expected = "Jan";
            var actual = source.SplitCutLeft(delimiter, index, false, CultureInfo.InvariantCulture);
            Assert.Equal(expected, actual);
        }
        ...
        public void SplitDelimiterAtBegining0()
        {
            ...
            var actual = source.SplitCutLeft(delimiter, index);
            Assert.Equal(expected, actual);
        }
        ...
        public void SplitStartIndexOkWord0()
        {
            ...
            var delimiter = "HELLO";
            var index = 0;
            var expected = "ELLOFeb";
            var actual = source.SplitCutLeft(delimiter, index, 5);
            Assert.Equal(expected, actual);
        }
        ...
        public void SplitStartIndexOkIgnoreCaseWord0()
        {
            ...
            var index = 0;
            var expected = "ELLOFeb";
            var actual = source.SplitCutLeft(delimiter, index, 5, false);
            Assert.Equal(expected, actual);
        }
        ...
        public void SplitStartIndexEndIndexWord0()
        {
            ...
            var index = 0;
            var expected = "LLOFeb";
            var actual = source.SplitCutLeft(delimiter, index, 5, 25, false);
            Assert.Equal(expected, actual);
        }
        ...
        public void SplitStartIndexEndIndexWord0WrongMatchCase()
        {
            ...
            var delimiter = "hello";
            var index = 0;
            var actual = source.SplitCutLeft(delimiter, index, 5, 25, true);
            Assert.Null(actual);
        }
        ...
        {
            var source = "Jan HELLOFebHELLO Mar HELLO April";
            var actual = source.SplitCutLeft("hello", 0, 5);
            Assert.Null(actual);
        }
        ...
        {
            var source = "JanHELLOFebHELLOMarHELLOApril";
            var actual = source.SplitCutLeft("hello", 0, 5, 25);
            Assert.Null(actual);
        }
        ...
        {
            var source = "JanHELLOFebHELLOMarHELLOApril";
            var actual = source.SplitCutLeft("hello", 0, 25, false);
            Assert.Null(actual);
        }
        ...
        {
            var source = "JanHELLOFebHELLOMarHELLOApril";
            var actual = source.SplitCutLeft("hello", 0, 0, 5, false);
            Assert.Null(actual);
        }
    }
}
