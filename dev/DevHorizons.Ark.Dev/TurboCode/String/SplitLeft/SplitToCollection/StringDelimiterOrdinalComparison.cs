...
namespace DevHorizons.Ark.Dev.TurboCode
{
    ...
    /// </Created>
    public static class StringDelimiterOrdinalComparison
    {
        /// <summary>
        ...
        /// </Created>
        public static List<string>? SplitLeftOrdinalComparison(this string source, string delimiter, bool ignoreCase)
        {
            return source.SplitLeftOrdinalComparison(delimiter, GetComparisonType(ignoreCase));
        }
        ...
        ///     <DateTime>01/07/2012  11:41 AM</DateTime>
        /// </Created>
        public static List<string>? SplitLeftOrdinalComparison(this string source, string delimiter, StringComparison comparisonType = StringComparison.Ordinal)
        {
            if (source == null)
            {
            ...
            return source.SplitLeftOrdinalComparisonInternal(delimiter, comparisonType);
        }
        ...
        ///     <DateTime>01/07/2012  11:41 AM</DateTime>
        /// </Created>
        public static List<string>? SplitLeftOrdinalComparison(this string source, string delimiter, int start, bool ignoreCase)
        {
            return source.SplitLeftOrdinalComparison(delimiter, start, GetComparisonType(ignoreCase));
        }
        ...
        ///     <DateTime>01/07/2012  11:41 AM</DateTime>
        /// </Created>
        public static List<string>? SplitLeftOrdinalComparison(this string source, string delimiter, int start, StringComparison comparisonType = StringComparison.Ordinal)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
            ...
            return source.Substring(start).SplitLeftOrdinalComparisonInternal(delimiter, comparisonType);
        }
        ...
        ///     <DateTime>01/07/2012  11:41 AM</DateTime>
        /// </Created>
        public static List<string>? SplitLeftOrdinalComparison(this string source, string delimiter, int start, int end, bool ignoreCase)
        {
            return source.SplitLeftOrdinalComparison(delimiter, start, end, GetComparisonType(ignoreCase));
        }
        ...
        ///     <DateTime>01/07/2012  11:41 AM</DateTime>
        /// </Created>
        public static List<string>? SplitLeftOrdinalComparison(this string source, string delimiter, int start, int end, StringComparison comparisonType = StringComparison.Ordinal)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
            ...
            return source.SliceLeftInternal(start, end).SplitLeftOrdinalComparisonInternal(delimiter, comparisonType);
        }
        ...
        ///     <DateTime>01/07/2012  11:41 AM</DateTime>
        /// </Created>
        public static List<string>? SplitLeftOrdinalComparisonInternal(this string source, string delimiter, StringComparison comparisonType = StringComparison.Ordinal)
        {
            if (delimiter.Length == source.Length)
            {
            ...
            for (var i = 0; i < len; i++)
            {
                var txtCut = source.Substring(i, delimiter.Length);
